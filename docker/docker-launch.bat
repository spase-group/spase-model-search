...
set /p src=
echo docker run -p 8080:80 --name website -v %src%/pages:/usr/share/nginx/html:ro nginx
docker run -p 8080:80 --name website -v %src%/pages:/usr/share/nginx/html:ro nginx